...
distance_between_markers = 2.0  # Actual distance between markers in meters
pixel_distance_between_markers = 1000  # Measured pixel distance between markers
conversion_factor = distance_between_markers / pixel_distance_between_markers
...
output_path = "C:/Users/micky/Documents/Ultra/output_video_4.mp4"
            ...
            if box.cls == 0:  # 0 represents the 'person' class
                ...
                for other_box in boxes:
                    if other_box.cls == 0 and other_box.id != box.id:
                        ...
                        # Convert pixel distance to metric distance using the conversion factor
                        distance_metric = distance_pixels * conversion_factor
                        ...
                        cv2.putText(denoised_frame, f"Distance: {distance_metric:.2f} meters", (x1, y1 - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
